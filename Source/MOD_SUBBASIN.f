      ...
      CONTAINS
        ...
        PURE ELEMENTAL REAL(8) FUNCTION AVERAGED_PRECIP(SEFT, ITER)

            CLASS(SUBBASIN_TYPE), INTENT(IN) :: SEFT
            INTEGER, INTENT(IN) :: ITER
            INTEGER :: I

            AVERAGED_PRECIP = 0.0D0
            DO I = 1, SEFT%NPRECIP_GATE
                AVERAGED_PRECIP = AVERAGED_PRECIP + SEFT%PRECIP(I)%GATE%GATE_DATA(ITER)*SEFT%THESEN_COEFF(I)
            ENDDO

        END FUNCTION AVERAGED_PRECIP
